...
// @api handler
import { getUser_details } from '../../../../api/authApi';

/***************************  HEADER - PROFILE DATA  ***************************/

const authUser = JSON.parse(localStorage.getItem("auth-user"));
const user_name = authUser?.data?.user?.name;


const profileData = {
  avatar: { src: '', size: AvatarSize.XS },
  title: user_name,
};
                    ...
                    <ListItem
                      secondaryAction={
                        <Switch
                          ...
                          onChange={() => {
                            const newMode = theme.palette.mode === ThemeMode.DARK ? ThemeMode.LIGHT : ThemeMode.DARK;
