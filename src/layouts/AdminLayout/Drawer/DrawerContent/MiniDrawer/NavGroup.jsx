...
export default function NavGroup({ item, onSelect }) {
  ...
  const renderNavItem = (menuItem) => {
    ...
    switch (menuItem.type) {
      case 'collapse':
        return <NavCollapse key={menuItem.id} item={menuItem} onSelect={onSelect} />;
      case 'item':
        return <NavItem key={menuItem.id} item={menuItem} onSelect={onSelect} />;
      default:
        return (
