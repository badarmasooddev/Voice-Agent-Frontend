...
const dashBoardImage = {
  light: '/assets/images/graphics/hosting/teralead-auth-img.webp',
  dark: '/assets/images/graphics/hosting/teraleads.png'
};
        ...
        <Stack sx={{ height: 1, justifyContent: 'space-between' }}>
          <Stack sx={{ alignItems: 'center', gap: 2 }}>
            ...
            <Typography variant="body2" color="text.secondary" align="center" sx={{ maxWidth: 400 }}>
              Teraleads AI: Effortlessly Automate Calls Using Intelligent Phone Agents!
            </Typography>
          </Stack>
