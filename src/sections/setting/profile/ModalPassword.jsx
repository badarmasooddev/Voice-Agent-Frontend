...
export default function ModalPassword({ inputSx, userId }) {
  ...
  console.log("user id for the pass update>>", userId)
  ...
  const onSubmit = async (data) => {
    try {
      await updatePassword(userId, data.oldPassword, data.password);
      setOpen(false);
      reset()
