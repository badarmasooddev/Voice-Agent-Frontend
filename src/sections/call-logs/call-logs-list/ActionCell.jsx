...
import AddNewAssistant from '@/sections/assistant/NewAssistant';
...
export default function ActionCell({ row, onDelete, onBlock }) {
  ...
  return (
    <>
      ...
      <AddNewAssistant open={openEditModal} onClose={handleEditModalClose} formData={editFormData} />
    </>
  );
}
