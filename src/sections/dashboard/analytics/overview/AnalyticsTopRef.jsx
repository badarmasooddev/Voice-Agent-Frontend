...
const sevenDaysData = [
  { title: 'Agent A', value: '12,340', progress: { value: 60 } },
  { title: 'Agent B', value: '7,890', progress: { value: 45 } },
  { title: 'Agent C', value: '5,670', progress: { value: 75 } },
  { title: 'Agent D', value: '3,210', progress: { value: 35 } },
  { title: 'Agent E', value: '9,800', progress: { value: 85 } },
  { title: 'Agent F', value: '4,500', progress: { value: 50 } }
];
...
const routesData = [
  { title: 'Campaign X', value: '50,120', progress: { value: 55 } },
  { title: 'Campaign Y', value: '22,340', progress: { value: 40 } },
  { title: 'Campaign Z', value: '15,780', progress: { value: 70 } },
  { title: 'Campaign A', value: '8,900', progress: { value: 30 } },
  { title: 'Campaign B', value: '28,450', progress: { value: 90 } },
  { title: 'Campaign C', value: '12,300', progress: { value: 65 } }
];
      ...
      <Grid container sx={{ borderRadius: 4, boxShadow: theme.customShadows.section, ...applyBorderWithRadius(16, theme) }}>
        <Grid size={{ xs: 12, sm: 6, md: 4 }}>
          <Stack sx={{ gap: 2.5, p: 3 }}>
            <Typography variant="subtitle1">Top Agent</Typography>
            <Box>
              {/* <Tabs
                variant="fullWidth"
                value={httpReferrers}
        ...
        <Grid size={{ xs: 12, sm: 6, md: 4 }}>
          <Stack sx={{ gap: 2.5, p: 3 }}>
            <Typography variant="subtitle1">Top Compaigns</Typography>
            <Box>
        ...
        <Grid size={{ xs: 12, md: 4 }}>
          <Stack sx={{ gap: 2.5, p: 3 }}>
            <Typography variant="subtitle1">Compaigns  Completed</Typography>
            <Box>
